...
|---|---|---|---|
| SOC Analyst Learning Path | Security Analyst | 🔵 En cours (3/25 modules) | [Voir →](https://github.com/mariamelkhamlichi/letsdefend-soc-analyst-path/tree/main/soc-analyst-learning-path) |
